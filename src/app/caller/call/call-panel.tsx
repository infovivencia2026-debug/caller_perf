      ...
      <form action={saveCall} className="space-y-3 p-4">
        ...
        <div className="sticky bottom-0 -mx-4 mt-1 border-t border-neutral-200 bg-white/90 px-4 py-3 backdrop-blur dark:border-neutral-800 dark:bg-black/85">
          <span data-shortcut="save" className="block">
            <SubmitButton
              noValidate={false}
              className="inline-flex w-full items-center justify-center whitespace-nowrap rounded-lg border border-indigo-500/50 bg-gradient-to-b from-indigo-500 to-indigo-600 px-4 py-3.5 text-base font-bold uppercase tracking-wide text-white shadow-[inset_0_1px_0_0_rgb(255_255_255/0.25),0_2px_4px_0_rgb(15_15_30/0.2),0_10px_20px_-8px_rgb(99_102_241/0.8)] transition-all hover:-translate-y-px hover:border-indigo-400 hover:from-indigo-400 hover:to-indigo-500 hover:shadow-[inset_0_1px_0_0_rgb(255_255_255/0.35),0_4px_8px_0_rgb(15_15_30/0.22),0_16px_28px_-10px_rgb(99_102_241/0.95)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 active:translate-y-0 active:shadow-[inset_0_2px_4px_0_rgb(15_15_30/0.3)] disabled:opacity-50"
              pendingLabel="Saving…"
            >
              Save &amp; next
            </SubmitButton>
