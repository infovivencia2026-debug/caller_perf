  ...
  return (
    <span className="relative block">
      ...
      <button
        ...
        tabIndex={-1}
        className="absolute inset-y-0 right-0 z-10 flex items-center px-3 text-slate-500 transition-colors hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100"
      >
        {visible ? (
          // eye-off
